...
python3 train.py \
 --load /mnt/nfs/scratch1/dchakraborty/pica/models/36epo_383000step.ckpt \
 --dataset /mnt/nfs/scratch1/dchakraborty/KAIST_SALIENCY/ \
 --batch_size 4 \
 --epoch 20 --learning_rate 0.001 --lr_decay 0.1 \
 --decay_step 40

#python3 image_test.py \ 
 #--model_dir /mnt/nfs/scratch1/dchakraborty/pica/models/state_dict/03022314/56epo_399881step.ckpt \
